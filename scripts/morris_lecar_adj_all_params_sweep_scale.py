...
_data = np.load('%s/meas_data/ML_%s_data_sigma=%.1f_stim_scale=%d.npy' %
				(data_dir, I_type, noise_sigma, stim_scale))[:-1, :]
times_data = _data[:, 0]
...
anneal1.save_paths("../../../data/oc-dspe/ML/adj/stim_scale/%s/"
					"all_sigma=%.1f_scale=%d_paths_%d.npy" 
					% (I_type, noise_sigma, stim_scale, seed))
anneal1.save_params("../../../data/oc-dspe/ML/adj/stim_scale/%s/"
					"all_sigma=%.1f_scale=%d_params_%d.npy" 
					% (I_type, noise_sigma, stim_scale, seed))
anneal1.save_action_errors("../../../data/oc-dspe/ML/"
					"adj/stim_scale/%s/all_sigma=%.1f_scale=%d_action_errors_%d.npy"
					% (I_type, noise_sigma, stim_scale, seed))
